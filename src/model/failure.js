#!/usr/bin/env sh
/*usr/bin/env true
export NODE_PATH="$NODE_PATH:/usr/local/lib/opa/static:/usr/local/lib/opa/stdlib:/usr/local/lib/opa/stdlib/stdlib.qmljs:`which npm > /dev/null 2>&1 && npm root -g`:node_modules:plugin:"
...
check_opa_deps(['ursa', 'opabsl.opp']);
require("opa-js-runtime-cps");
require("opabsl.opp");
require("calendar.controller.opx");
